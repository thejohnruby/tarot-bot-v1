...
Случайным образом вытяни одну из 78 карт классической колоды Таро Уэйта. Постарайся, чтобы карты не повторялись.
...
Пиши дружелюбно, понятно и немного мистически, чтобы вызвать интерес у человека. Красиво, с разделением на обзацы. 
Каждый абзац с новой строки и символом. 
Объём до 220 слов. 
"""
